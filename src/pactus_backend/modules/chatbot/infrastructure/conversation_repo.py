...
from ....core.exceptions.base import ConflictError, InternalServerError
from ....core.infrastructure.base import PostgresBaseRepository
from ....modules.chatbot.application.repositories import IConversationRepository
from ....modules.chatbot.domain import ChatbotDatabaseUnavailableError, ConversationTable
