...
async def get_company_area_chart(
    ...
    return AreaChartResponse.model_validate(response)
...
async def get_company_alert_center(service: DashboardServiceDep, current_user: CurrentUserDep) -> list[AlertCategory]:
    ...
    return [AlertCategory.model_validate(item) for item in response]
...
async def get_company_recent_contracts(service: DashboardServiceDep, current_user: CurrentUserDep) -> Sequence[RecentContractResponse]:
    ...
    return [RecentContractResponse.model_validate(item) for item in response]
...
async def get_top_companies(
    ...
    return [TopCompanyResponse.model_validate(item) for item in response]
...
async def get_top_services(
    ...
    return [TopServiceResponse.model_validate(item) for item in response]
