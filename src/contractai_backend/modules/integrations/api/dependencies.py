...
from contractai_backend.shared.infrastructure.database import get_aclient, get_client, get_session
...
async def get_document_command_service(
    ...
    from contractai_backend.modules.documents.composition import build_default_document_command_service  # noqa: PLC0415
